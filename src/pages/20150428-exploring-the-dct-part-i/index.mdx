...
<Figure caption="A 8&times;8 DCT-II" centered>
...
<Figure caption="A na&iuml;ve DCT implementation in JavaScript">
```js
...
<Figure caption="The DCT-III, also known as the inverse DCT" centered>
...
<Figure caption="A na&iuml;ve iDCT implementation in JavaScript">
```js
...
<Figure caption="A 1-D DCT and iDCT">
...
<Figure caption={"A na&iuml;ve implementation of a forward 1D DCT."}>
```js
...
<Figure caption={"A na&iuml;ve implementation of a inverse 1D DCT."}>
```js
