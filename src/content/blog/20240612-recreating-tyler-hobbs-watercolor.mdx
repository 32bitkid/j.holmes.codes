...
As you can see, using this seemingly "basic" algorithm&mdash;with careful adjustment of the function parameters&mdash;we can achieve very organic looking shapes!
